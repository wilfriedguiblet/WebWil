...
Inheriting Your Advisor's Philosophy
Kateryna Makova - Nov 24th 2015
Makova_24_Nov_2015

Un oeuf with the French puns already !
Samarth Rangavittal - Jan 18th 2016
Rangavittal_18_Jan_2016

Collaboration: Just As with Any Relationship, Open Communication Is the Key to Success
Sarah Craig - Feb 29th 2016
Craig_29_Feb_2016

Treat statistics as a science, and not a recipe.
Marzia Cremona - April 10th 2016
Cremona_10_Apr_2016
...
def blog():
	...
	lines = map(lambda x: x.strip(), lines)
	lines = filter(None, lines)
	group = [iter(lines)] *BLOG_FIELD_COUNT
	return zip(*group)
